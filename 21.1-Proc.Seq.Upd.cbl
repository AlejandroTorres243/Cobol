      ...
      ******************************************************************
       ...
       *>Listing 10-5. Update with added AddToStock
       *>and SubtractFromStock transactions
       ...
       *> This version includes additions and subtractions from QtyInStock
       ...
       01 ErrorMessage.
           ...
           02 FILLER PIC X(46).
              ...
              88 QtySubtractError
              VALUE "Stock Subtract Error - No such record in Master".
              88 InsufficientStock
              VALUE "Stock Subtract Error - Not enough stock".
       1 FILLER PIC X VALUE "n".
