      ...
      *> Receiving item for DATE YYYYMMDD system variable: 
      *  Format is YYYYMMDD
       01 Y2KDate.
          02 Y2KYear          PIC 9(4).
          02 Y2KMonth         PIC 99.
      ...
      *> Receiving item for DAY YYYYDDD system variable: 
      * Format is YYYYDDD
       01 Y2KDayOfYear.
       ...
       Begin.
           ...
           DISPLAY "El nombre es " UserName 
           DISPLAY "Fecha: " CurrentDay "-"  CurrentMonth "-" 
                   CurrentYear 
           DISPLAY "Hoy es el día " YearDay " del año"
           DISPLAY "Hora:" CurrentHour " Minuto:" CurrentMinute 
