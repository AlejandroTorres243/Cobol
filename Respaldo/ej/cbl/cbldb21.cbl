      ...
      * USER DEFINED ERROR MESSAGE
       ...
       01 W-FULLNAME   PIC X(50)  VALUE SPACES.
       01  EOF-CURSOR        PIC 9(1) VALUE 0.
           88 EOF-CURSOR-NO     VALUE 0.
           88 EOF-CURSOR-SI     VALUE 1.
      *****************************************************
      * SQL DECLARATION FOR VIEW ACCOUNTS                 *
      *****************************************************
                EXEC SQL DECLARE ZA0023T TABLE
      ...
      *****************************************************
       LIST-ALL.
           ...
           PERFORM UNTIL EOF-CURSOR-SI
             PERFORM PRINT-A-LINE 
             PERFORM FETCH-CURSOR
           END-PERFORM
           PERFORM CLOSE-CURSOR
           PERFORM SELECT-SINGLE
           .
       ...
       SELECT-SINGLE.
           EXEC SQL  
               SELECT *
                 ...
                 FROM ZA0023T
                WHERE ACCTNO > "17891797" 
           END-EXEC

           IF SQLCODE NOT = 0 THEN 
              MOVE 'SELECT GEORGE' TO UD-ERROR-MESSAGE
              PERFORM SQL-ERROR-HANDLING
           ELSE
              DISPLAY 'GEORGE:' CUSTOMER-RECORD 
           END-IF
           .
       ...
       FETCH-CURSOR.
           ...
           EVALUATE SQLCODE
             WHEN 0     SET EOF-CURSOR-NO TO TRUE
             WHEN +100  SET EOF-CURSOR-SI TO TRUE
             WHEN OTHER
